require = function() {
  ...
  1: [function(t, e, r) {
      ...
      "@marcom/ac-feature/cssPropertyAvailable": 4
  }],
  2: [function(t, e, r) {
      "use strict";
  ...
  4: [function(t, e, r) {
      ...
      "@marcom/ac-function/memoize": 12,
      "@marcom/ac-prefixer/getStyleProperty": 22,
      "@marcom/ac-prefixer/getStyleValue": 23
  }],
  5: [function(t, e, r) {
      "use strict";
      e.exports = {
  ...
  6: [function(t, e, r) {
      ...
      var n = t("@marcom/useragent-detect").os,
          ...
          a = t("./helpers/globals"),
          c = t("@marcom/ac-function/once");
      e.exports = c(o), e.exports.original = o
  }, {
      "./helpers/globals": 5,
      "./touchAvailable": 10,
      "@marcom/ac-function/once": 13,
      "@marcom/useragent-detect": 33
  }],
  7: [function(t, e, r) {
      "use strict";
      ...
      function o() {
          var t = i.getWindow(),
              e = t.screen.width;
          return t.orientation && t.screen.height < e && (e = t.screen.height), !n() && e >= c
      }
  ...
  14: [function(t, e, r) {
      ...
      "./ac-gpu-reporter/GPUReporter": 15
  }],
  15: [function(t, e, r) {
      "use strict";

      function o() {}
      var n = t("@marcom/ac-feature/webGLAvailable"),
          i = t("./defaults"),
          a = o.prototype;
      a.BLACKLISTED = 1, a.WHITELISTED = 2, a.NOT_LISTED = 4, a.NOT_FOUND = 8, a.NO_WEBGL = 16, a.getGPUClass = function(t) {
          var e, r = this._extendLists(t);
          return n() ? (e = this.getGPU(), null !== e ? this._matchesList(e, r.whitelist) ? this.WHITELISTED : this._matchesList(e, r.blacklist) ? this.BLACKLISTED : this.NOT_LISTED : this.NOT_FOUND) : this.NO_WEBGL
      }, a.getGPU = function() {
          var t, e, r;
          return t = document.createElement("canvas"), e = t.getContext("webgl") || t.getContext("experimental-webgl") || t.getContext("moz-webgl"), e ? (r = e.getExtension("WEBGL_debug_renderer_info"), null !== r ? e.getParameter(r.UNMASKED_RENDERER_WEBGL) : e.getParameter(e.VERSION)) : null
      }, a._matchesList = function(t, e) {
          var r;
          for (r = 0; r < e.length; r++)
              if (this._matchesEntry(t, e[r])) return !0;
          return !1
      }, a._matchesEntry = function(t, e) {
          var r, o = t.toLowerCase(),
              n = e.toLowerCase().split(" "),
              i = !0;
          for (r = 0; r < n.length; r++) o.indexOf(n[r]) === -1 && (i = !1);
          return i
      }, a._extendLists = function(t) {
          var e, r = JSON.parse(JSON.stringify(i));
          if (void 0 !== t) {
              if (void 0 !== t.blacklist && t.blacklist.length > 0)
                  for (e = 0; e < t.blacklist.length; e++) r.blacklist.push(t.blacklist[e]);
              if (void 0 !== t.whitelist && t.whitelist.length > 0)
                  for (e = 0; e < t.whitelist.length; e++) r.whitelist.push(t.whitelist[e])
          }
          return r
      }, e.exports = o
  }, {
      "./defaults": 16,
      "@marcom/ac-feature/webGLAvailable": 11
  }],
  16: [function(t, e, r) {
      "use strict";
      e.exports = {
  ...
  21: [function(t, e, r) {
      ...
      "@marcom/ac-feature/touchAvailable": 10
  }],
  22: [function(t, e, r) {
      "use strict";
      ...
      "./shared/getStyleTestElement": 24,
      "./shared/prefixHelper": 25,
      "./shared/stylePropertyCache": 26,
      "./utils/toCSS": 28,
      "./utils/toDOM": 29
  }],
  23: [function(t, e, r) {
  ...
  27: [function(t, e, r) {
      ...
      "./getStyleTestElement": 24,
      "./stylePropertyCache": 26
  }],
  28: [function(t, e, r) {
      "use strict";
  ...
  40: [function(t, e, r) {
      ...
      function i(t, e, r, o) {
          ...
          s(e, n) || (l && a ? u(e, n) : c ? f(e, i) : t === x ? u(e, n) : t === O && f(e, n))
      }
  ...
  48: [function(t, e, r) {
      ...
      function i() {
          var t = "Apple A7 GPU" === g || "Apple A8 GPU" === g || y.os.ios && y.os.version.major <= 10 || y.os.android && m();
          return !u && !t && s("position", "sticky") && p()
      }
      var a = t("@marcom/ac-headjs"),
          c = t("@marcom/ac-feature/prefersReducedMotion"),
          s = t("@marcom/ac-feature/cssPropertyAvailable"),
          u = document.documentElement.classList.contains("aow"),
          l = (t("@marcom/ac-feature/threeDTransformsAvailable"), t("@marcom/ac-css-mask/featureDetectTest")),
          f = s("position", "sticky"),
          p = t("@marcom/ac-feature/canvasAvailable"),
          m = t("@marcom/ac-feature/isTablet"),
          y = t("@marcom/useragent-detect"),
          d = t("@marcom/ac-gpu-reporter").GPUReporter,
          h = new d,
          g = h.getGPU();
      a.addTests({
          "css-mask": t("@marcom/ac-css-mask/featureDetectTest"),
          "faceid-enhanced": i() && s("will-change") && !c(),
          "inline-video": n(),
          "materials-enhanced": !c() && f,
          "chip-enhanced": !c() && f && !document.documentElement.classList.contains("aow"),
          "progressive-image": !0,
          "reduced-motion": c(),
          "static-interaction": o(),
          sticky: f,
          webgl: i(),
          "sprite-sheet-player": p() && !document.documentElement.classList.contains("aow")
      }), a.addTests(l), a.htmlClass()
  }, {
      "@marcom/ac-css-mask/featureDetectTest": 2,
      "@marcom/ac-feature/canvasAvailable": 3,
      "@marcom/ac-feature/cssPropertyAvailable": 4,
      "@marcom/ac-feature/isTablet": 7,
      "@marcom/ac-feature/prefersReducedMotion": 8,
      "@marcom/ac-feature/threeDTransformsAvailable": 9,
      "@marcom/ac-gpu-reporter": 14,
      "@marcom/ac-headjs": 20,
      "@marcom/useragent-detect": 33
  }],
