! function t(e, r, i) {
  ...
  1: [function(t, e, r) {
      ...
      "./className/add": 2,
      "@marcom/ac-polyfills/Array/prototype.slice": 6,
      "@marcom/ac-polyfills/Element/prototype.classList": 7
  }],
  2: [function(t, e, r) {
      "use strict";
      var i = t("./contains");
  ...
  10: [function(t, e, r) {
      ...
      function i(t, e) {
          e = s(o, e || {}), this.el = t, this._selectors = {
              wrapper: "." + e.className,
      ...
      var s = t("@marcom/ac-object/defaults"),
      ...
      c._initializeDirectory = function() {
          if (this._directory = this.el.querySelector(this._selectors.directory), this._directory)
              for (var t, e, r, i = this._directory.querySelectorAll(this._selectors.directory + "-column-section-state"), s = 0; s < i.length; s++) t = i[s].nextElementSibling, e = t.querySelector(this._selectors.directory + "-column-section-anchor-open"), r = t.querySelector(this._selectors.directory + "-column-section-anchor-close"), n.create(i[s], e, r)
      ...
      "./internal/CheckboxMenu": 11,
      "@marcom/ac-object/defaults": 15
  }],
  11: [function(t, e, r) {
      "use strict";
  ...
  16: [function(t, e, r) {
      ...
      "@marcom/ac-polyfills/Array/prototype.forEach": 14
  }],
  17: [function(t, e, r) {
      "use strict";
  ...
  25: [function(t, e, r) {
      ...
      "./ac-globalfooter/GlobalFooter": 26
  }],
  26: [function(t, e, r) {
      "use strict";
      ...
      "@marcom/ac-footer/Footer": 10,
      "@marcom/ac-headjs/FeatureDetect": 13
  }]
}, {}, [25]);